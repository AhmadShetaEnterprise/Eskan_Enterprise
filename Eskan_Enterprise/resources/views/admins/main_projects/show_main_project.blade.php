            ...
            <div class="card-body col-lg-12"  style="width: 20rem;">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{ url('showConstruction/'.$unit->constructions->id) }}" class="btn btn-primary m-2">{{$unit->constructions->name}}</a></td>
                            <td><a href="{{ url('unitShow/'.$unit->id) }}" class="btn bg-warning m-2" style="width: 125px">{{$unit->name}}</a></td>
                            <td><a href="#" class="btn bg-info m-2" style="width: 125px">{{$unit->properties->name}}</a></td>
                            <td><a href="{{ url('customerShow/'.$unit->customers->id) }}" class="btn bg-danger m-2" style="width: 125px">{{$unit->customers->name}}</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>

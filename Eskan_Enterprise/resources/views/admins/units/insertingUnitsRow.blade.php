...
<div class="row d-inline-flex">
    <div class="col-lg-1">
        ...
        <input type="text" class="form-control   text-dark" style="width='20px'" name="name[]" required>
    </div>
    ...
    <div class="col-lg-2">
        ...
        <input type="hidden" value="{{ $construction->id }}" class="form-control   text-dark" style="width='20px'" name="construction_id[]" required>
    ...
    <div class="col-lg-1">
        ...
        <input type="text" class="form-control   text-dark" style="width='20px'" name="level_id[]" required>
    </div>

    <div class="col-lg-1">
        <label for="">الموقع</label>
        <input type="text" class="form-control   text-dark" style="width='20px'" name="site[]" required>
    </div>

    <div class="col-lg-1">
        <label for="">المساحة</label>
        <input type="text" value="{{ $space }}" class="form-control   text-dark" style="width='20px'" name="space[]" required>
    </div>

    <div class="col-lg-1">
        <label for="">سعر المتر</label>
        <input type="text" value="{{ $price_m }}" class="form-control   text-dark" style="width='20px'" name="price_m[]" required>
    </div>
    ...
    <div class="col-lg-1">
        ...
        <select class="custom-select l   text-dark" style="width='20px'" name="status[]" >
    ...
    <div class="col-lg-1">
        ...
        <select class="custom-select l   text-dark" style="width='20px'" name="customer_id[]" >
